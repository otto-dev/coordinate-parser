...
Coordinates = (function() {
  function Coordinates(coordinateString, lonLatFormat) {
  ...
  Coordinates.prototype.validate = function() {
    ...
    return validator.validate(this.coordinates, this.lonLatFormat);
  };
  ...
  Coordinates.prototype.groupCoordinateNumbers = function() {
    ...
    this.latitudeNumbers = this.lonLatFormat ? coordinateNumbers.slice(0 - numberCountEachCoordinate) : coordinateNumbers.slice(0, numberCountEachCoordinate);
    return this.longitudeNumbers = this.lonLatFormat ? coordinateNumbers.slice(0, numberCountEachCoordinate) : coordinateNumbers.slice(0 - numberCountEachCoordinate);
  };
